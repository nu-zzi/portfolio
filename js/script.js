...
function _profilePageChartPercent() {
    activate = 0;
    ...
    $(window).scroll(function () {
        ...
        var css = $('#CSS').offset().top;

        if (sct >= profile && sct < css) {
            activateScene2();
        } else {
            no_activateScene2();
        };
...
>>>>>>> 03ad9523a3e939f88e39adeda93c20ebc348d11e
}

function _contactPageLettering() {
    $(".title").lettering();
    $(".button").lettering();
